CREATE TABLE [dbo].[VASRebateStructureDetail] (
...
ALTER TABLE [dbo].[VASRebateStructureDetail]
    ADD CONSTRAINT [FK_VASRebateStructureDetail_VASRebateStructure] FOREIGN KEY ([VASRebateStructureId]) REFERENCES [dbo].[VASRebateStructure] ([Id]);
...
ALTER TABLE [dbo].[VASRebateStructureDetail]
    ADD CONSTRAINT [PK_VASRebateStructureDetail] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 90);
...
ALTER TABLE [dbo].[VASRebateStructureDetail]
    ADD CONSTRAINT [uq_VASRebateStructureDetail] UNIQUE NONCLUSTERED ([VASProductId] ASC, [VASRebateStructureId] ASC) WITH (FILLFACTOR = 90) ON [AEON_NC_Index_FG];
...
-- =============================================
CREATE TRIGGER [dbo].[utr_VASRebateStructureDetail_ChangeTracking] ON [dbo].[VASRebateStructureDetail]
FOR INSERT,
	DELETE,
	UPDATE
AS
...
SELECT @TableName = 'VASRebateStructureDetail'

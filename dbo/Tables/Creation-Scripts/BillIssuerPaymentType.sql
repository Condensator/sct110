CREATE TABLE [dbo].[BillIssuerPaymentType] (
    [Id]                  INT           IDENTITY (1, 1) NOT NULL,
    [BillIssuerId]        INT           NOT NULL,
    [PaymentTypeId]       INT           NOT NULL,
    [BillIssuerReference] NVARCHAR (50) NULL,
...
ALTER TABLE [dbo].[BillIssuerPaymentType]
    ADD CONSTRAINT [DF_BillIssuer_PaymentType_IsDeleted] DEFAULT ((0)) FOR [IsDeleted];
...
ALTER TABLE [dbo].[BillIssuerPaymentType]
    ADD CONSTRAINT [FK_BillIssuer_PaymentType_BillIssuer] FOREIGN KEY ([BillIssuerId]) REFERENCES [dbo].[BillIssuer] ([Id]);
...
ALTER TABLE [dbo].[BillIssuerPaymentType]
    ADD CONSTRAINT [FK_BillIssuer_PaymentType_PaymentType] FOREIGN KEY ([PaymentTypeId]) REFERENCES [dbo].[PaymentType] ([Id]);
...
ALTER TABLE [dbo].[BillIssuerPaymentType]
    ADD CONSTRAINT [PK_BillIssuer_PaymentType] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 90);
...
-- =============================================
CREATE TRIGGER [dbo].[utr_BillIssuer_PaymentType_ChangeTracking] ON [dbo].[BillIssuerPaymentType]
FOR INSERT,
	DELETE,
	UPDATE
AS
...
SELECT @TableName = 'BillIssuerPaymentType'

CREATE TABLE [dbo].[VASCommissionStructureDetailFuture] (
...
ALTER TABLE [dbo].[VASCommissionStructureDetailFuture]
    ADD CONSTRAINT [DF_VASCommissionStructureDetailFuture_IsSliding] DEFAULT ((0)) FOR [IsSliding];
...
ALTER TABLE [dbo].[VASCommissionStructureDetailFuture]
    ADD CONSTRAINT [FK_VASCommissionStructureDetailFuture_VASCommissionStructure] FOREIGN KEY ([VASCommissionStructureId]) REFERENCES [dbo].[VASCommissionStructure] ([Id]);
...
ALTER TABLE [dbo].[VASCommissionStructureDetailFuture]
    ADD CONSTRAINT [FK_VASCommissionStructureDetailFuture_VASProduct] FOREIGN KEY ([VASProductId]) REFERENCES [dbo].[VASProduct] ([Id]);
...
ALTER TABLE [dbo].[VASCommissionStructureDetailFuture]
    ADD CONSTRAINT [PK_VASCommissionStructureDetailFuture] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 90);
...
ALTER TABLE [dbo].[VASCommissionStructureDetailFuture]
    ADD CONSTRAINT [uq_VASCommissionStructureDetailFuture] UNIQUE NONCLUSTERED ([VASProductId] ASC, [VASCommissionStructureId] ASC) WITH (FILLFACTOR = 90) ON [AEON_NC_Index_FG];
...
-- =============================================
CREATE TRIGGER [dbo].[utr_VASCommissionStructureDetailFuture_ChangeTracking] ON [dbo].[VASCommissionStructureDetailFuture]
FOR INSERT,
	DELETE,
	UPDATE
AS
...
SELECT @TableName = 'VASCommissionStructureDetailFuture'
